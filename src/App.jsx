      ...
      <div className="hidden bg-[#1B2831] xl:flex flex-col">
        ...
        <div className="p-4 h-[15vh]">
          <div className="flex items-center justify-between mb-4">
            <div>
              <img
                src="https://img.freepik.com/foto-gratis/hombre-atractivo-gafas-sol-ropa-formal-pie-brazos-cruzados_171337-10734.jpg"
        ...
        <div className="h-[85vh] overflow-y-scroll">
          ...
          <div className="p-4 flex items-center gap-4 bg-[#222C32] border-b border-[#222C32] hover:cursor-pointer">
            <img
              src="https://img.freepik.com/foto-gratis/retrato-joven-atractivo-parece-evaluativo_295783-887.jpg"
              className="w-10 h-10 object-cover rounded-full"
            />
            <div className="flex-1 flex justify-between">
              <div>
                <h1>sebastian tovar</h1>
          ...
          <div className="p-4 flex items-center gap-4 hover:bg-[#222C32] border-b border-[#222C32] transition-colors hover:cursor-pointer">
            <img
              src="https://as1.ftcdn.net/v2/jpg/04/31/37/94/1000_F_431379488_3FybIJLjB9LyWYVCRt1sTQswnCq2wY2q.jpg"
              className="w-10 h-10 object-cover rounded-full"
            />
            <div className="flex-1 flex justify-between">
              <div>
      ...
      <div className="xl:col-span-3">
        <header className="h-[8vh] bg-[#1B2831] p-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <img
              src="https://img.freepik.com/foto-gratis/retrato-hombre-atractivo-satisfecho-contento
              -feliz-camisa-moda-mezclilla-que-muestra-su-dedo-indice-esquina-superior-derecha_295783-1217.jpg"
              className="w-10 h-10 object-cover rounded-full"
            />
            <div>
              <h1>Jorge Luis Trejo</h1>
